...
class Profile extends Component {
            ...
            .then(response => {
                ...
                if (response.status === 200) {
                    ...
                    response.data.forEach(element => {
                        var date = new Date(element.requestTimeStamp);
                        element.requestTimeStamp =  (date.getMonth()+1) + '/' + date.getDate() + '/' + date.getFullYear()
                    });
                    this.setState({
    ...
    handleSwapHistory = () => {
        ...
        this.setState({ showSwapHistoryModal: true });
        ...
        return (
            <div>
                ...
                <div class="container">
                    <div className="row mt-3">
                        ...
                        <div className="col-sm-7">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <button type="button" id="swapBookAdd" class="btn btn-primary btn-block pull-right" onClick={this.handleSwapHistory}>View Swap History</button>
                    ...
                    <Modal
                        isOpen={this.state.showSwapHistoryModal}
                        onRequestClose={this.closeModal}
                        contentLabel="Example Modal" >
                        <div>
                            <div class="container">
                                <div class="panel panel-default">
                                    <h class="panel-heading" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}><b>Swap History</b></h>
                                    <div className="panel panel-default p50 uth-panel">
                                        <table className="table table-hover">
                                            ...
                                            <tbody>
                                                {this.state.swapHistory.map(history =>
                                                    <tr key={history._id}>
                                                        <td>{history.bookName}</td>
                                                        <td>{history.authorName}</td>
                                                        <td>{history.rname}</td>
                                                        <td>{history.requestTimeStamp}</td>
                                                    </tr>
                                                )
                                                }
                                            </tbody>
